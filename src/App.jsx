...
const projects = [
	...
	},
	{
		...
		shortTitle: "TaskGenie: Service Marketplace",
		type: "Service Discovery & Booking Platform",
		category: "fullstack",
		featured: true,
		status: "Nov. 2025",
		desc: "An end-to-end service discovery and booking platform built with Node.js, Express.js, and PostgreSQL featuring geospatial provider lookup and secure payment pipelines.",
		highlights: [
			"End-to-end service discovery and booking platform with provider scheduling, ratings, and customer reviews",
			"Geospatial provider lookup using PostgreSQL spatial indexing, reducing query latency by 80%",
	...
	},
	{
		...
		featured: false,
		status: "AI Research",
		desc: "AI-powered mobile assistant built for senior care featuring voice memory aids, emergency triage alerts, and offline intent classification.",
		highlights: [
		...
		tags: ["Flutter", "Dart", "Llama 3.1", "BERT Engine"],
